...
public class TermsAndConditions {
    ...
    public var data : TermsAndConditionsData?
    public var errors : TermsAndConditionsErrors?
    
    
    public class func modelsFromDictionaryArray(array:NSArray) -> [TermsAndConditions]
    {
        var models:[TermsAndConditions] = []
        for item in array
        {
            models.append(TermsAndConditions(dictionary: item as! NSDictionary)!)
        }
        return models
    }
    ...
    required public init?(dictionary: NSDictionary) {
        ...
        if (dictionary["data"] != nil) { data = TermsAndConditionsData(dictionary: dictionary["data"] as! NSDictionary) }
        if (dictionary["errors"] != nil) { errors = TermsAndConditionsErrors(dictionary: dictionary["errors"] as! NSDictionary) }
    }
...
public class TermsAndConditionsData {
    ...
    public var workPlace : TermsAndConditionsDataWorkPlace?
    ...
    public class func modelsFromDictionaryArray(array:NSArray) -> [TermsAndConditionsData]
    {
        var models:[TermsAndConditionsData] = []
        for item in array
        {
            models.append(TermsAndConditionsData(dictionary: item as! NSDictionary)!)
        }
        return models
    }
    ...
    required public init?(dictionary: NSDictionary) {
        ...
        if (dictionary["workPlace"] != nil) { workPlace = TermsAndConditionsDataWorkPlace(dictionary: dictionary["workPlace"] as! NSDictionary) }
...
public class TermsAndConditionsErrors {
    
   
    public class func modelsFromDictionaryArray(array:NSArray) -> [TermsAndConditionsErrors]
    {
        var models:[TermsAndConditionsErrors] = []
        for item in array
        {
            models.append(TermsAndConditionsErrors(dictionary: item as! NSDictionary)!)
        }
        return models
    }
...
public class TermsAndConditionsDataWorkPlace {
    public var en : String?
    public var ar : String?
    
  
    public class func modelsFromDictionaryArray(array:NSArray) -> [TermsAndConditionsDataWorkPlace]
    {
        var models:[TermsAndConditionsDataWorkPlace] = []
        for item in array
        {
            models.append(TermsAndConditionsDataWorkPlace(dictionary: item as! NSDictionary)!)
        }
        return models
    }
